...
// 1. THÔNG TIN HIVEMQ CLOUD
#define HIVEMQ_HOST "4a1375dbae154624a6759636e2559329.s1.eu.hivemq.cloud" 
#define HIVEMQ_USER "esp32s3_demomqtts"                   // Username 
#define HIVEMQ_PASS "12345678"                  // Password 

// 2. chứng chỉ SSL từ file hivemq_ca.pem 
...
static void mqtt_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        // --- B. PUBLISH (Gửi 1 tin nhắn lên HiveMQ) ---
    ...
    case MQTT_EVENT_DATA:
        // --- C. LẤY DỮ LIỆU NHẬN ĐƯỢC TỪ WEB CLIENT ---
